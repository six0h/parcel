			...
			success: function(res) {
				...
				if(res.status == 200) {
					...
					if(res.num_plays == 1) { // FIRST TIME
						...
						$('#result .copy-box p').html("We've got more parcels with more great Sydney experiences every day. So, remember to come back tomorrow and have another go.<br/><br/>In the meantime, click continue to discover what Sydney has to offer.").css('font-size','0.9em');
						$('#result .button-small, #result #result-btn').hide();
